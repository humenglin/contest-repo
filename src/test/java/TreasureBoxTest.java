...
public class TreasureBoxTest {
    ...
    public void should_return_right_mysterious_no_and_hash_value_given_8th_box() {
        TreasureBox treasureBox = new TreasureBox(8, "000003c049b07a37c88607c2bb741a58008c9e5fa83119ec69b6e1f8bbb546ed");
        int actualMysteriousNo = treasureBox.findRightMysteriousNo();
        assertEquals(58324, actualMysteriousNo);

        int mysteriousNo = 58324;
        String actualHashValue = treasureBox.calculateHashValue(mysteriousNo);
        assertEquals("00000b648556bf66847a187d6c6579dbd3f77036af54dd89ed565c451f39e4b6", actualHashValue);
    }

    @Test
    public void should_return_right_mysterious_no_and_hash_value_given_9th_box() {
        TreasureBox treasureBox = new TreasureBox(9, "00000b648556bf66847a187d6c6579dbd3f77036af54dd89ed565c451f39e4b6");
        int actualMysteriousNo = treasureBox.findRightMysteriousNo();
        assertEquals(197357, actualMysteriousNo);

        int mysteriousNo = 197357;
        String actualHashValue = treasureBox.calculateHashValue(mysteriousNo);
        assertEquals("0000014a40bec11d9008c3b87c5e27052b2475169d0fbb587bc362b44e626b86", actualHashValue);
    }

    @Test
    public void should_return_right_mysterious_no_and_hash_value_given_10th_box() {
        TreasureBox treasureBox = new TreasureBox(10, "0000014a40bec11d9008c3b87c5e27052b2475169d0fbb587bc362b44e626b86");
        int actualMysteriousNo = treasureBox.findRightMysteriousNo();
        assertEquals(613080, actualMysteriousNo);

        int mysteriousNo = 613080;
        String actualHashValue = treasureBox.calculateHashValue(mysteriousNo);
        assertEquals("00000541f44ca5de75aa7994e8652d0faea40be43e2e0b90bdbd8214b7afd3de", actualHashValue);
    }
}
